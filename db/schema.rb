...
ActiveRecord::Schema.define(:version => 20121212215154) do
  ...
  add_index "contact_information_sets", ["order_id"], :name => "index_contact_information_sets_on_order_id"
  ...
  add_index "content_items", ["for_html_id"], :name => "index_content_items_on_for_html_id"
  add_index "content_items", ["language"], :name => "index_content_items_on_language"
  add_index "content_items", ["page_id"], :name => "index_content_items_on_page_id"
  ...
  add_index "custom_data_fields", ["custom_data_id"], :name => "index_custom_data_fields_on_custom_data_id"
  ...
  add_index "custom_data_rows", ["custom_data_id"], :name => "index_custom_data_rows_on_custom_data_id"
  ...
  create_table "galleries", :force => true do |t|
    ...
    t.text     "liquid",                :limit => 2147483647
  ...
  create_table "looks", :force => true do |t|
    ...
    t.text     "blogentry",   :limit => 2147483647
  end
  ...
  create_table "pages", :force => true do |t|
    ...
    t.text     "translated_attributes_data", :limit => 2147483647
  ...
  add_index "product_property_keys", ["website_id"], :name => "index_product_property_keys_on_website_id"
  ...
  add_index "product_property_values", ["product_id"], :name => "index_product_property_values_on_product_id"
  add_index "product_property_values", ["product_property_key_id"], :name => "index_product_property_values_on_product_property_key_id"
  add_index "product_property_values", ["product_variant_id"], :name => "index_product_property_values_on_product_variant_id"
  ...
  add_index "shipping_costs", ["website_id"], :name => "index_shipping_costs_on_website_id"
  ...
  add_index "translated_page_attributes", ["language_short_code"], :name => "index_translated_page_attributes_on_language_short_code"
  add_index "translated_page_attributes", ["page_id"], :name => "index_translated_page_attributes_on_page_id"
  ...
  create_table "versions", :force => true do |t|
    ...
    t.string   "user_type"
    t.string   "user_name"
    t.text     "modifications",  :limit => 2147483647
    t.integer  "number"
    t.string   "tag"
    t.datetime "created_at"
    t.datetime "updated_at"
